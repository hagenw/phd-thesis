...
header = ['y point_source line_source plane_wave focused_source ', ...
    'WFS_25D_point_source WFS_25D_line_source WFS_25D_plane_wave ', ...
    'WFS_25D_focused_source WFS_25D_focused_source_low_pass ', ...
    'WFS_25D_point_source_wo_approx'];
gp_save('data/amplitudes_25D.txt',M,header);
