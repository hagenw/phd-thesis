...
for jj=1:length(X)
    ...
    gp_save(sprintf('lowpass_wfs_X%.2f_Y%.2f.txt',X(jj),Y(jj)),[t/conf.fs p]);
end
...
for jj=1:length(X)
    ...
    gp_save(sprintf('lowpass_wfs_X%.2f_Y%.2f_nls64.txt',X(jj),Y(jj)),[t/conf.fs p]);
end
...
for jj=1:length(X)
    ...
    gp_save(sprintf('highpass_wfs_X%.2f_Y%.2f.txt',X(jj),Y(jj)),[t/conf.fs p]);
end
...
for jj=1:length(X)
    ...
    gp_save(sprintf('highpass_wfs_X%.2f_Y%.2f_nls64.txt',X(jj),Y(jj)),[t/conf.fs p]);
end
