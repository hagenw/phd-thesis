#!/usr/bin/gnuplot
#
# Comparison of amplitude spectrum of real vs. simulated sources
#
...
# wxt
set terminal epslatex size 10cm,8cm color colortext
set output 'pinta_recordings.tex'
set format '$%g$'
