#!/usr/bin/gnuplot
#
# Plot setup for the circular loudspeaker array and NFC-HOA localization experiment
#
...
set terminal epslatex size 5cm,10cm color colortext
set output 'hoa_circular_array.tex'
