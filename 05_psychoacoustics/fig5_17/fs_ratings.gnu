#!/usr/bin/gnuplot
#
# Artifact ratings for focused sources in 2.5D WFS 
#
...
set terminal epslatex size 10cm,5cm color colortext
set output 'fs_ratings.tex'
...
set xlabel 'array length / m' offset 0,-0.35
